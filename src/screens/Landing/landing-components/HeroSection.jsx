  ...
  return (
    <div className="flex pt-[150px]">
      <div className="sm:w-8/12 w-full flex flex-col justify-center sm:items-start items-center lg:px-32 sm:px-20 px-0  lg:gap-7 z-20">
        <h2 className="lg:text-6xl sm:text-darkblue dark:sm:text-semiWhite mb-5 whitespace-nowrap text-3xl">
          مرجع اموزش برنامه نویسی
        </h2>
        <p className="sm:text-[#03001CB2] dark:sm:text-whitePink lg:text-[24px] sm:text-md leading-[40px] sm:text-right text-center">
        ...
        <div className="flex gap-6 lg:mt-20 mt-10 w-full px-10 whitespace-nowrap">
          ...
          <button className="primary-btn sm:w-auto w-full">
            از کجا شروع کنیم؟
          </button>
        </div>
      </div>
      <div className="hero-section-image-side">
        <div className="lg:w-[600px] sm:w-[400px] relative inline-block w-full">
          ...
          <img
            ...
            className="z-[5] relative lg:w-[523px] sm:w-[340px] hidden sm:block"
          />
          <img
