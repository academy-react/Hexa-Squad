...
const CourseBody = ({ title, courseCount, time, date, professorName, like, dislike, studentCount, price }) => {
  return (
    <div className="course-body mt-6">
      ...
      <div className="">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="course-svg">
          <path stroke-linecap="round" stroke-linejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-4.179 2.25m0 0L21.75 12l-4.179 2.25m0 0l4.179 2.25L12 21.75 2.25 16.5l4.179-2.25m11.142 0l-5.571 3-5.571-3" />
        </svg>
        <p className="course-info pl-6">{courseCount}</p>

        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="course-svg">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
        <p className="course-info pl-6">{time}</p>

        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="course-svg">
          <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
        </svg>
        <p className="course-info">{date}</p>
      </div>
      ...
      <div className="pt-8">
        ...
        <p className="course-info text-sm">{professorName}</p>
        <div className="course-like-box mr-11">
          <img src={likePic} alt="picture" className="inline" />
          <p className="course-like-count">{like}</p>
        </div>
        <div className="course-like-box mr-2">
          <img src={dislikePic} alt="picture" className="inline" />
          <p className="course-like-count">{dislike}</p>
        </div>
      </div>
      <div className="mt-6 border-t-2 border-[#00018533] pt-4 pb-8">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="course-svg w-6 h-6">
