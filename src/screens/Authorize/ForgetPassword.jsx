        ...
        <div className="lg:flex block">
            ...
            <div className="w-full lg:w-5/12 flex justify-center">
                <div className="form-section-auth" dir='rtl'>
                    ...
                    <p className="w-[300px] mx-auto pr-[10px] text-base text-right lg:mt-4 my-10 text-lightblue ">در صورتی که رمز عبور خود را فراموش کرده اید، لطفا ایمیل یا موبایل خود را وارد کنید </p>
