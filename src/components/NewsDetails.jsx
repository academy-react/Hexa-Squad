...
import UserComments from './NewsDetails/UserComments';
import InputComment from './NewsDetails/InputComment';
...
import '../screens/Landing/landing-components/common.css';
    ...
    return(
        <div className="pt-24 lg:pt-40 mb-52">
            <div className="news-details">
                <div className="flex lg:flex-row flex-wrap border-b-2 border-b-[#3F40EA33] dark:border-b-[#3d3d70] mx-auto pb-12">
                    <div className='relative'>
                        ...
                        <div className="absolute bottom-[55px] left-6 md:right-12">
                            ...
                            <span className="inline text-xl">2057بازدید</span>
                        </div>
                    </div>
                    <div className="max-w-[660px] pr-6 md:pr-1 lg:pr-6">
                        <p className="text-[#3B3CA7] dark:text-[#6974FF] text-xl md:text-3xl mb-6">چگونه مطالعه ی موثر را برای شما اسان تر کنیم</p>
                ...
                <p className="text-xl lg:text-[26px] text-darkblue3 dark:text-[#6974FF] py-6">چگونه اموزش ببینیم ؟</p>
                ...
                <p className="news-details-text pt-14 pb-4">مثال: </p>
                ...
                <div className="flex flex-row justify-between border-b-2 border-b-[#3F40EA33] dark:border-b-[#3d3d70] py-6">
                    <div className="news-details-text pt-2">به اشتراک گذاری:</div>
