...
const NewsDetails = () => {
    ...
    return(
        <div className="pt-40 mb-52">
            <div className="news-details lg:max-w-[1260px] mx-auto p-16 rounded-xl bg-[#ECEBFF] shadow-shadow-newsDetails-page">
                <div className="flex lg:flex-row flex-wrap border-b-2 border-b-[#3F40EA33] mx-auto pb-12">
                    <img src={newsDetails1} alt="picture" className=" p-2"  />
                    <div className="max-w-[660px] pr-6">
                        <p className="text-[#3B3CA7] text-3xl mb-6">چگونه مطالعه ی موثر را برای شما اسان تر کنیم</p>
                        <div className="inline text-[#403393] text-sm "> 
                ...
                <p className="text-[26px] text-darkblue3 py-6">چگونه اموزش ببینیم ؟</p>
                ...
                <p className="news-details-text  pb-12 border-b-2 border-b-[#3F40EA33] ">با تشکر از:
                    <span className="text-darkblue2 pr-2">نام گردآورنده</span>
                </p>
                <div className="flex flex-row justify-between border-b-2 border-b-[#3F40EA33] py-6">
                    <div className="news-details-text pt-2">به اشتراک گذاری:</div>
                    <div className="flex flex-row  w-[194px] ">
                        <div className="media-icons-border">
                            <svg class="media-icons w-8 h-8 m-2.5" fill="#8E8EAA" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="mt-40 pb-6 border-b-2 border-b-[#3F40EA33] ">
                    <img src={comment} className="inline pl-4"/>
                    <h3 className="text-2xl text-darkblue4 inline">نظرات کاربران در رابطه با این مقاله </h3>
                </div>
            </div>
        </div>
    )
