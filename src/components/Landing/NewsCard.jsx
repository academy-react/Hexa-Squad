      ...
      >
        <Link to={id ? "/newsDetails/" + id : "/undefinedError"}>
          <div className="absolute cursor-pointer group mr-[220px] md:mr-[260px] lg:mr-[265px] mt-1 md:mt-6 lg:mt-1 ">
            ...
            <h2 className="news-description whitespace-pre-wrap md:text-sm h-[80px] w-[95%] text-justify text-xs md:my-4 mt-2 pl-6 text-lightblue skeleton-handler dark:text-[#cbc7ff] dark:opacity-90 dark:group-hover:text-[#DEDCFF] opacity-60">
