  ...
  return (
    <header className='rounded-xl absolute flex h-[110px] w-full z-50' id='header'>
        <ul className='w-full flex items-center px-[20px]  '>
            ...
            <Link to='/' className='z-20 relative'><img src={Logo} alt="Hexa Squad Logo" className='md:logo md:block hidden dark:hidden ' /><img src={LogoIcon} alt="Hexa Squad Logo" className='logo md:hidden ' /><img src={LogoWhite} alt="Hexa Squad Logo" className='md:logo hidden dark:md:block' /></Link>                <svg  viewBox="0 0 476 222" fill="none" xmlns="http://www.w3.org/2000/svg" className='logo-bg'>
