...
const Login = () => {
  return (
    <div className="form-section-auth loginModal fixed w-[400px] pt-12 top-[16%] lg:left-[38%] md:left-[22%] sm:left-[10%] left-[5%] right-[50%] z-[500] shadow-shadow-all hidden bg-whitePink" dir='rtl'>
      <label htmlFor="showLoginModal" className='cursor-pointer'><i className='absolute bi bi-x top-5 right-5 text-newPurpleAlpha2 text-4xl'></i></label>
